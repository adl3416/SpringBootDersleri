...
@Configuration // data olusturup database deki tablonun icine gonderme islemi yapar
public class StudentBean05Config {
	
	@Bean  // obje donduren methodlarda Bean kullanilir
	...
	return args -> {
		...
		studentRepo.saveAll(List.of(aliCan, veliHan, maryStar));  // save all methodu jpa repo dan gelir extends yaptigimiz icin
	};
